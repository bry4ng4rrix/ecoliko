                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.school_rounded, color: Colors.indigoAccent, size: 36),
                    ),
                    ...
                    Text(
                      ...
                      style: TextStyle(color: Colors.indigo.shade100.withValues(alpha: 0.8), fontSize: 13, fontWeight: FontWeight.w500),
                    ),
                      ...
                      child: Padding(
                        ...
                        child: Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              const Text('Connexion', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w700)),
                              const SizedBox(height: 4),
                              Text(
                                'Saisissez vos identifiants pour accéder à votre espace',
                                style: TextStyle(color: const Color(0xFF94A3B8), fontSize: 12.5),
                              ),
