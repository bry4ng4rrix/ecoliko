...
/// Équivalent de `ROLE_HOME` (frontend/src/components/ProtectedRoute.jsx) — seuls les 4
/// rôles couverts par cette application mobile ont une destination ; les autres (RESPONSABLE,
